...
public class FullCalendarView {
    ...
    private List<Integer> periode= new ArrayList<Integer>();
   ...
   private List<LocalDate> DatePrecedent= new ArrayList<LocalDate>();
    ...
    public FullCalendarView(YearMonth yearMonth) {
        ...
        taDates.clear();
        taDates.add(LocalDate.parse("2018-07-01"));
        taDates.add(LocalDate.parse("2018-08-08"));
        periode.add(10);
        periode.add(15);
    ...
    public void populateCalendar(YearMonth yearMonth) {
        ...
        List<Integer> periode2= new ArrayList<Integer>();
         ...
         {       
                ...
                while(((nbJour=nbJour+periode.get(i))<365)&& (LocalDate.ofYearDay(ld.getYear(), nbJour).getMonthValue()==(currentYearMonth.getMonthValue())))
                {   
                     ld1= LocalDate.ofYearDay(ld.getYear(),nbJour);
                     Dates.add(ld1);
                     periode2.add(periode.get(i));           
                 }           
                if(nbJour<365)
                {
                     ld1= LocalDate.ofYearDay(ld.getYear(),nbJour);
       ...
       DatePrecedent.clear();
        ...
        List<Integer> periode2= new ArrayList<Integer>();
         ...
         {  
                ...
                Integer nbJour= ld.getDayOfMonth();
                nbJour=ld.getDayOfYear();
                while(((nbJour=nbJour-periode.get(i))>0)&& (LocalDate.ofYearDay(ld.getYear(), nbJour).getMonthValue()==(currentYearMonth.getMonthValue())))
                {   
                     ld1= LocalDate.ofYearDay(ld.getYear(),nbJour);
                     Dates.add(ld1);
                     periode2.add(periode.get(i));
